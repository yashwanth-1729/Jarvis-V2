...
export function useCommandCenter() {
  ...
  const status: "offline" | "syncing" | "online" = error || localOnly ? "offline" : refreshing ? "syncing" : "online";
  ...
  return {
    state, view, setView, loading, refreshing, error, voiceOpen, setVoiceOpen, settingsOpen, setSettingsOpen, chatOpen, setChatOpen, voiceAvailable, recordsLocal, wideViewport, refresh, handleSynced, handleRegenerateBrief, handleToggleTask, handleRecordChanged, handleAgentRefresh, railCounts, status, surfaceProps, setSurface, localOnly
  };
}

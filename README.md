...
mute/send, stop reply and the existing half-duplex default. Motion is confined
to short screen, selection and press feedback, with reduced-motion/transparency
fallbacks. Illustration assets will be supplied by the user, not generated by
